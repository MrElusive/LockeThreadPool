...
public class ForkJoinMatrixInverse extends RecursiveAction {
	...
	public ForkJoinMatrixInverse(Matrix matrix) {
		this.matrix = matrix;
	}
	...
	public void compute() {
		if (matrix.getNumRows() == 1) {
			...
			ForkJoinMatrixInverse forkJoinMatrixInverse11 = new ForkJoinMatrixInverse(matrix11);
			forkJoinMatrixInverse11.fork();

			ForkJoinMatrixInverse forkJoinMatrixInverse22 = new ForkJoinMatrixInverse(matrix22);
	...
	public static void main(String[] args) {
		...
		ForkJoinMatrixInverse forkJoinMatrixInverse = new ForkJoinMatrixInverse(inverse);
